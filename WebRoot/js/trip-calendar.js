...
Y.TripCalendar = Y.extend(Calendar, Y.Base, {
    ...
    renderUI: function() {
        ...
        this.boundingBox = Y.one('#' + this._calendarId).setStyle('position', container ? 'inherit' : 'initial');
                            ...
                            '<div class="container">' +
                                ...
                                '<div class="content-box">' +
                                    '<div class="arrow">' +
                                        ...
                                        '<span class="prev-btn {delegate_click}" title="上月">选择日期</span>' +
                                        '<span class="close-btn {delegate_click}" title="关闭"><</span>' +
                                        
                                        '<span class="next-btn {delegate_click}" title="下月">选择日期</span>' +
                                    '</div>' +
                                    '<div class="date-box">' +
                                        '{date_template}' +
                                    '</div>' +
