(function ($) {
    ...
    */
    $.fn.MyConfirm = function (options, callback) {
        ...
        //要生成的html页面
        var html = "<div class='tip' style='z-index:2147483510'><div class='tip-pop' style='z-index:2147483509'></div> <div class='tip-con' style='z-index:2147483511'><div class='tip-top'>" + title + "</div> <div class='tip-cer'><dl><dt>" + content + "</dt><dd>  ";
        if (options.hasCancelBtn)
            html += "<a id='' class='_over'>确定</a><a id=''>取消</a>";
        else
            html += "<a id='' class='_over' style='width:100%;'>确定</a>";
    ...
    $.fn.LoadingShow = function (){
    	 var html = "<div class='tip'><div class='tip-pop'><div class='tip-loading'></div></div></div>";
         //添加到body中
         $("body").append(html);
         //设置背景高斯模糊
         $(containerId).addClass(blurClassName);
