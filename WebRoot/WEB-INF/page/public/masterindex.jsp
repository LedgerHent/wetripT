...
<fms:Content contentPlaceHolderId="main">
	...
	<div id="contont_ticket">
		...
		<form id="wf" action="flight/getFlightList.act">
			
		</form>
		<form id="lc" action="flight/getFlightList.act">
		</form>
		...
		<%-- <div class="header">
				<ul class="res-header-main" style=" ">
					...
					<!-- <img src="img/home.png" onclick="window.location.href='flight/search.act';" style="width:2rem;height: 2rem;padding-top: 1rem;cursor: pointer;padding-left:0.4rem;"></li>
