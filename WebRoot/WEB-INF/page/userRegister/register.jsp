		...
		<section>
			...
			<ul class="content-flyer">
				...
				<li class="con-list bor" style="border-bottom:none;">
					<div style="width:100%;">
						<span class="name">邮箱</span> <input type="text" name="email" placeholder="必填" id="email" value="${email }" readonly="readonly" style="width:60%;">
					</div></li>
