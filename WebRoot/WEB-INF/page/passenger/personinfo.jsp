...
<html>
	...
	<body>
		...
		<form action="<%=path %>/wetrip/updateorsave.act" id="save" method="post">
		...
		<section>
			<header>
				...
				<p class="zhixiang">个人信息修改</p>
			</header>
			<ul class="content-flyer">
				<li class="con-list bor">
				<div>
					<span class="name">姓名</span>
					<input name="name" placeholder="必填" value="${name }" id="username">
				...
				<div>
					...
					<input  name="mobile" placeholder="必填" value="${phone }" id="usermobile">
					</div>
				</li>
				<li class="con-list choose bor">
					<div class="lefts">
						<span class="name">类型</span>
						<span class="name people" id="type">成人</span>
				...
				<div>
					...
					<input type="text" name="email" placeholder="选填" value="${email }" id="email">
					</div>
				</li>
				...
				<ul>
					<li class="item-list">
						...
						<div class="the">
							<div>
								<span >证件号码</span>
							<input type="text" name=num placeholder="必填" class="card" value="${idcard }" id="idnum">
							</div>
							<!-- <img src="img/add.png"/> -->
						</div>
					</li>
