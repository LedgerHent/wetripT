...
/**
 * HotelPayInfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "HOTEL_PAY_INFO")
public class HotelPayInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public HotelPayInfo(String orderno, Integer amount) {
		this.orderno = orderno;
		this.amount = amount;
	}
	
	public HotelPayInfo(String orderno, Integer amount,String subject,String body,String nonceStr,String notifyUrl,String returnUrl,Integer type) {
		this(orderno, amount, subject, body, nonceStr, notifyUrl, returnUrl, type, null, null, null, null, null, null);
	}

	/** full constructor */
	public HotelPayInfo(String orderno, Integer amount, String subject,
