...
public abstract class IntlTicketPCClient <T extends Request_Base,K extends Response_Base> extends etuf.v1_0.controller.base.v2.base.Client<T,K> {
	private static Logger logger = LoggerFactory.getLogger(IntlTicketPCClient.class);
	private static final String INTLTICKET_PREFIX = "intlTicketPC";
	@Override
	protected void SetServerUrl() {
		try {
			...
			if(logger.isDebugEnabled()){
				logger.debug("IntlTicketPCClient.SetServerUrl()→url=" + url);
			}
		} catch (IOException e) {
