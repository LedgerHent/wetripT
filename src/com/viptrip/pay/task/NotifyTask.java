...
public class NotifyTask extends TimerTask {
    ...
    public NotifyTask(Notify notify,TaskService service,Map<String,Object> param){
        this.notify = notify;
    ...
    public NotifyTask(Notify notify,TaskService service,Map<String,Object> param,Algorithm alg){
        this.notify = notify;
        this.service = service;
        this.map = param;
        this.alg = alg;
    ...
    public void run() {
        ...
        try {
            ...
            if("SUCCESS".equalsIgnoreCase(result)){
                ...
                notify = service.update(notify);//更新通知状态
                this.cancel();
                timer.cancel();
                alg = null;
                map = null;
    ...
    private void doRetryOrNot(){
        ...
        if(notify.getCount()< PayConfig.maxCount){//是否达到最大重试次数
            ...
            notify = service.update(notify);//更新通知次数
