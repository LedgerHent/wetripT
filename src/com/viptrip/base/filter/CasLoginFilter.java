package com.viptrip.base.filter;
...
public class CasLoginFilter  extends AbstractCasFilter {
	 /**
    ...
    protected CasLoginFilter(final Protocol protocol) {
        super(protocol);
    }
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        List<String> list = PropertiesUtils.readFileList(Const.FILE_CAS_EXCLUDE_CONFIG);
