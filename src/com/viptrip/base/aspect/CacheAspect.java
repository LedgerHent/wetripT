...
public class CacheAspect {
	...
	@AfterReturning(pointcut = "add()", returning="rtv")
	public void addAfterReturnning(JoinPoint jp, Object rtv){
		
	}
	
	@AfterReturning(pointcut = "update()", returning="rtv")
	public void updateAfterReturnning(JoinPoint jp, Object rtv){
		
	}
	
	@AfterReturning(pointcut = "delete()", returning="rtv")
	public void deleteAfterReturnning(JoinPoint jp, Object rtv){
