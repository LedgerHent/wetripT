...
/**   
 * @Title: IdcardValidatorUtil.java 
 * @Package com.caissa.caissadebris.utils 
 * @Description: 身份证校验工具 
 * @author ChenZheng  
 * @date 2017年5月24日 下午1:09:53 
 * @Copyright 2017 Beijing CAISSA International Travel Service * Co., Ltd All rights reserved. 
 * @version V1.0   
 */
...
/**
 * @ClassName: IdcardValidatorUtil.java
 * @Description: 身份证校验工具
 * @author ChenZheng
 * @date 2017年5月24日 下午1:09:53
 * 
 *       --15位身份证号码：第7、8位为出生年份(两位数)，第9、10位为出生月份，第11、12位代表出生日期，第15位代表性别，奇数为男，
 *       偶数为女。
 *       --18位身份证号码：第7、8、9、10位为出生年份(四位数)，第11、第12位为出生月份，第13、14位代表出生日期，第17位代表性别，
 *       奇数为男，偶数为女。 最后一位为校验位
 * 
 */
public class IdcardValidatorUtil {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String idcard18 = "110108198101240035";//
    // 15位身份证
