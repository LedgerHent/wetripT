...
public class Request_GetHotelList extends Request_Base{
	...
	private String tripPolicyRemindType; //差旅策略类型
	
	private Integer pageSize = 10;	
	
	private Integer choicePageNum = 1;		//精选酒店pageNum
	private Integer agreementPageNum = 1;	//协议酒店pageNum
	...
	public Integer getChoicePageNum() {
		return choicePageNum;
	}

	public void setChoicePageNum(Integer choicePageNum) {
		this.choicePageNum = choicePageNum;
	}

	public Integer getAgreementPageNum() {
		return agreementPageNum;
	}

	public void setAgreementPageNum(Integer agreementPageNum) {
		this.agreementPageNum = agreementPageNum;
	}
}
