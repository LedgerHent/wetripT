...
public class PersonalInfo extends
TicketClient<Request_PersonalInfo, Response_PersonalInfo>{

	@Override
	protected OutputSimpleResult DataValid(Request_PersonalInfo arg0) {
	...
	@Override
	protected OutputResult<Response_PersonalInfo, String> DoBusiness(
			Request_PersonalInfo arg0) {
			OutputResult<Response_PersonalInfo, String> or = new OutputResult<Response_PersonalInfo, String>();
			...
			TTravelPassenger ttp=new TTravelPassenger();
			
			Req_Passenger p = arg0.getAddP();
			ttp.setUserid(arg0.getUserId());
			ttp.setName(p.getName());
			ttp.setMobilephone(p.getMobile());
			ttp.setEmail(p.getEmail());
			ttp.setPassengerType(p.getType()+"");
			...
			if(type==null || "".equals(type)){
				...
				ttp.setIdtype(String.valueOf(type));
			}
			ttp.setIdnumber(person.getNum());

			service.updatePersonalInfo(ttp);

			or.setResultObj(new Response_PersonalInfo());
			return or;
		}
