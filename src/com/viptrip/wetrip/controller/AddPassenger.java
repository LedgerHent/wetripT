...
public class AddPassenger extends
		TicketClient<Request_AddPassenger, Response_AddPassenger> {
	...
	@Override
	protected OutputResult<Response_AddPassenger, String> DoBusiness(
			Request_AddPassenger passenger) {
		...
		Req_Passenger p = passenger.getAddP();
