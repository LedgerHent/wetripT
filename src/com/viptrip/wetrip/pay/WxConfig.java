...
public class WxConfig {
	...
	public static final String NOTIFY_URL_MWEB;
	public static final String RETURN_URL_MWEB;
	...
	//mweb支付通知url
	private static final String DEFAULT_NOTIFY_URL_MWEB="pay/wxntf.act";
	private static final String DEFAULT_RETURN_URL_MWEB="pay/wxrtn.act";
	...
	static{
		...
		String NOTIFY_URL_MWEB1;
		String RETURN_URL_MWEB1;
		...
		try {
			...
			NOTIFY_URL_MWEB1 = PropertiesUtils.getProperty(Const.PRO_WX_URL_NOTIFY_MWEB, Const.FILE_PAY_CONFIG);
			RETURN_URL_MWEB1 = PropertiesUtils.getProperty(Const.PRO_WX_URL_RETURN_MWEB, Const.FILE_PAY_CONFIG);
			...
			Assert.notNull(NOTIFY_URL_MWEB1);
			Assert.notNull(RETURN_URL_MWEB1);
			...
			NOTIFY_URL_MWEB1 = DEFAULT_NOTIFY_URL_MWEB;
			RETURN_URL_MWEB1 = DEFAULT_RETURN_URL_MWEB;
		}
		WAP_NAME = WAP_NAME1;
		WAP_URL = WAP_URL1;
		...
		MCHID = MCHID1;
		KEY = KEY1;
		NOTIFY_URL_MWEB = NOTIFY_URL_MWEB1;
		RETURN_URL_MWEB = RETURN_URL_MWEB1;
	}
