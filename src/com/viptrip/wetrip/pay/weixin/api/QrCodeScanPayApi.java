...
public class QrCodeScanPayApi {
	...
	private static Logger log = LoggerFactory.getLogger(QrCodeScanPayApi.class);
	...
	public static String getCodeUrl(String appid, String mch_id, String product_id, String paternerKey, boolean isToShortUrl){
		...
		if (isToShortUrl) {
			String shortResult = WXPayApi.toShortUrl(WXPayApi.buildShortUrlParasMap(appid, null, mch_id, null, qrCodeUrl, paternerKey));
	...
	public static void scanModeOnePayCallBack(HttpServletRequest request ,HttpServletResponse response, String paternerKey, String body,CallBackProductId a) throws Exception{
		...
		if (StringUtil.isNotEmpty(return_code) && StringUtil.isNotEmpty(result_code) && return_code.equalsIgnoreCase("SUCCESS")&&result_code.equalsIgnoreCase("SUCCESS")) {
	 ...
	 * @return
	 */
	public static AjaxResp scanModeTwoPay(String appid, String sub_appid, String mch_id, String sub_mch_id, String device_info, String body, String detail, String attach, String out_trade_no, String total_fee, String spbill_create_ip, String notify_url, String trade_type, String paternerKey){
		AjaxResp ajax = new AjaxResp();
		Map<String, String> params = WXPayApi.buildUnifiedOrderParasMap(appid, sub_appid, mch_id, sub_mch_id, device_info, body, detail, attach, out_trade_no, total_fee, spbill_create_ip, notify_url, trade_type, paternerKey,null);
		String xmlResult = WXPayApi.pushOrder(params);
		Map<String, String> map = PaymentKit.xmlToMap(xmlResult);
		String return_code = map.get("return_code");
		String return_msg = map.get("return_msg");
		if (StringUtil.isEmpty(return_code) || !"SUCCESS".equals(return_code)) {
			ajax.fail(return_msg);
			return ajax;
		}
