...
//	protected String out_trade_no;
	...
	public WXMwebPayReq(String baseUrl) {
		super();
		this.trade_type = "MWEB";
		this.notify_url = baseUrl + WxConfig.NOTIFY_URL_MWEB;
		this.scene_info = "{\"h5_info\":{\"type\":\"WAP\",\"wap_url\":\"http://we.viptrip365.com/wetrip/\",\"wap_name\":\"凯撒商旅\"}}";
	}
	
	public WXMwebPayReq(String out_trade_no,Integer total_fee,String ip,String body,String baseUrl) {
		super(out_trade_no);
		this.body = body;
